...
@section('title', 'Active Support & Backer Letter | ExtremeSolutions')
...
<div class="bg-slate-100 min-h-screen py-8 sm:py-14"
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div class="mb-4">
            <a href="{{ route('support.index') }}" class="text-xs font-semibold text-slate-500 hover:text-slate-900 inline-flex items-center">
                &larr; Back to ExtremeSolutions Support &amp; Mission
            </a>
        </div>
