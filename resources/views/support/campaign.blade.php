...
<div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 bg-slate-900/90 border border-slate-800 p-3.5 sm:p-4 rounded-xl shadow-lg text-xs font-sans text-white">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <button type="button"
                        ...
                        class="inline-flex items-center px-3.5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-lg text-xs transition shadow-sm cursor-pointer">
    ...
    <div class="flex justify-center">
        <article id="letter-paper"
                 class="print-paper max-w-[794px] w-full mx-auto bg-white p-4 sm:p-11 md:p-12 text-slate-900 font-sans text-[13px] leading-relaxed shadow-xl rounded-sm border border-slate-200 print:border-none print:shadow-none print:p-0 relative">
