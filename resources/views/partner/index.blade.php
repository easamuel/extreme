...
@section('description', 'Partner with ExtremeSolutions: Systems integrator alliances, enterprise software co-creation, and technology distribution frameworks.')
    ...
    <section class="relative overflow-hidden bg-[#071326] text-white pt-20 pb-24 md:pt-28 md:pb-32 border-b border-white/10">
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="mx-auto mt-6 max-w-2xl text-base sm:text-lg leading-relaxed text-slate-300">
                ExtremeSolutions is a digital solutions and software engineering company. We partner with systems integrators, regional advisors, enterprise consultants, and innovators to build and scale digital systems that last.
            </p>
