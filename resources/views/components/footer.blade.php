        ...
        <div class="grid gap-12 pb-14 lg:grid-cols-[1.3fr_2fr] lg:gap-20">
            ...
            <div class="max-w-full">
                ...
                <p class="mt-5 max-w-sm text-sm leading-relaxed text-white/70">
                    Building and operating dependable custom software, school management systems, and workflow automation for modern institutions and enterprises.
                </p>
            ...
            <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 max-w-full">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2.5">
                        ...
                        <li>
                            <a href="{{ route('home') }}#operational-clarity" class="text-xs text-white/70 hover:text-white transition-colors">Common Questions</a>
                        </li>
                        <li>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <ul class="mt-4 space-y-2.5">
                        ...
                        <li class="pt-2">
                            <a href="tel:09052585622" class="text-xs text-white/80 hover:text-[#00ff88] transition-colors flex items-center gap-1.5">
                                <svg class="h-3.5 w-3.5 text-[#00ff88]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
